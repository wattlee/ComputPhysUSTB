...
Y = compute_Ylm(l,m,theta,phi);  % The original code does not work since
%the function compute_Ylm is not given. Use another spherical hamonic
%master package instead.s
